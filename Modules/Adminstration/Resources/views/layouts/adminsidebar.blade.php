            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="/admin-dashboard"><i class="icon-speedometer"></i><span class="hide-menu">Dashboard</span></a>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-grid2"></i><span class="hide-menu">Categories</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="/adminstration/levels">Levels</a></li>
                                <li><a href="/adminstration/classes">Classes</a></li>
                                <li><a href="/adminstration/subjects">Subjects</a></li>
                                <li><a href="/adminstration/committees">Committees</a></li>
                                <li><a href="/adminstration/users-category">User Category</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-email"></i><span class="hide-menu">Registration</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="/adminstration/students-registration">Students</a></li>
                                <li><a href="/adminstration/get-teaching-staffs">Teaching Staff</a></li>
                                <li><a href="/adminstration/non-teaching-staffs">Non Teaching Staff</a></li>
                            </ul>
                        </li>
