...
<head>
    ...
    <body>
        ...
        <div class="as-mainwrapper">
            ...
            <div class="bg-white3">
                ...
                <div class="background-area no-animation">	
                    <img src="{{ asset('front/img/slider/1.jpg')}}" style="width:100%;" alt=""/>
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-12">
                                <div class="about-container">
                                    <h3>WHY EDUCATION SPONSORSHIP ?</h3>
        ...
        amr songr balga ami toami valo lasi ciri din akr dali</p>
                ...
                <!--End of About Area-->
                <!--Course Area Start-->
                <div class="course-area section-padding" style="background:#ffffff">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-12">
                                <div class="single-product-item">
                                    <div class="single-product-image">
                                        <a href="#"><img src="{{ asset('front/img/product/1.jpg')}}" alt=""></a>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-12">
                                <div class="single-product-item">
                                    <div class="single-product-image">
                                        <a href="#"><img src="{{ asset('front/img/product/2.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="single-product-text">
                                        <h4><a href="#">Title Product Here</a></h4>
                                        <h5>Book</h5>
                            ...
                            <div class="col-lg-3 col-md-6 col-12">
                                <div class="single-product-item">
                                    <div class="single-product-image">
                                        <a href="#"><img src="{{ asset('front/img/product/3.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="single-product-text">
                                        <h4><a href="#">Title Product Here</a></h4>
                                        <h5>Book</h5>
                            ...
                            <div class="col-lg-3 col-md-6 col-12">
                                <div class="single-product-item">
                                    <div class="single-product-image">
                                        <a href="#"><img src="{{ asset('front/img/product/4.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="single-product-text">
                                        <h4><a href="#">Title Product Here</a></h4>
                                        <h5>Book</h5>
                                    ...
                                    <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2">
                                        <div class="testimonial-image-slider text-center">
                                            <div class="sin-testiImage">
                                                <img src="{{ asset('front/img/testimonial/1.jpg')}}" alt="testimonial 1" />
                                            </div>
                                            <div class="sin-testiImage">
                                                <img src="{{ asset('front/img/testimonial/2.jpg')}}" alt="testimonial 2" />
                                            </div>
                                            <div class="sin-testiImage">
                                                <img src="{{ asset('front/img/testimonial/3.jpg')}}" alt="testimonial 3" />
                                            </div>
                                            <div class="sin-testiImage">
                                                <img src="{{ asset('front/img/testimonial/1.jpg')}}" alt="testimonial 1" />
                                            </div>
